            ...
            <c:if test="${ad!=null}">
                <div id="user-info">
                    ...
                    <c:if test="${ad.role==1}">
                        ...
                        <a style="color: white;text-decoration: none" href="deletefilm" >  Edit phim  </a>
        ...
        <div class="slider-frame">
            <div class="slide-images">
                <div class="img-container">
                    <img src="./assets/images/emvatrinh.jpg" alt style="width: 100%">
                </div>
                <div class="img-container">
                    <img src="./assets/images/minion.jpg" alt style="width: 100%">
                </div>
                <div class="img-container">
                    <img src="./assets/images/BlackAdam.jpg" alt style="width: 100%">
                </div>
            </div>
        </div>
        <div id="content">
